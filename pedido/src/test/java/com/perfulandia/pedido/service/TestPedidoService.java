...
public class TestPedidoService {
    ...
    void testListarPedidos() {
        Pedido p1 = new Pedido(1L, 1, EstadoPedido.CREADO, "Dir 1", LocalDateTime.now(), 50.0, Arrays.asList(new Detalle(1L, 1, 2, 10.0, 20.0, null)));
        Pedido p2 = new Pedido(2L, 2, EstadoPedido.PROCESANDO, "Dir 2", LocalDateTime.now(), 30.0, Arrays.asList(new Detalle(2L, 2, 1, 15.0, 15.0, null)));
    ...
    @Test
    void testGuardar() {
        Pedido pedido = new Pedido(null, 1, EstadoPedido.CREADO, "Dir 1", LocalDateTime.now(), 50.0, Arrays.asList(new Detalle(null, 1, 2, 10.0, 20.0, null)));
        Pedido pedidoGuardado = new Pedido(1L, 1, EstadoPedido.CREADO, "Dir 1", LocalDateTime.now(), 50.0, Arrays.asList(new Detalle(    1L, 1, 2, 10.0, 20.0, null)));
    ...
    void testActualizarEstado() {
        Pedido pedido = new Pedido(1L, 1, EstadoPedido.CREADO, "Dir 1", LocalDateTime.now(), 50.0, Arrays.asList(new Detalle(1L, 1, 2, 10.0, 20.0, null)));
        Pedido pedidoActualizado = new Pedido(1L, 1, EstadoPedido.PROCESANDO, "Dir 1", LocalDateTime.now(), 50.0, Arrays.asList(new Detalle(1L, 1, 2, 10.0, 20.0, null)));
