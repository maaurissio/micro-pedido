...
public class TestDetalleService {
    ...
    @Test
    void testDetalles() {
        Detalle d1 = new Detalle(1, 1, 2, 10.0, 20.0, new Pedido(1, 1, null, "Dir 1", null, 0.0, null));
        Detalle d2 = new Detalle(2, 2, 1, 15.0, 15.0, new Pedido(2, 2, null, "Dir 2", null, 0.0, null));
    ...
    void testGuardar() {
        ...
        Detalle detalle = new Detalle(0, 1, 2, 10.0, 20.0, pedido);
        Detalle detalleGuardado = new Detalle(1, 1, 2, 10.0, 20.0, pedido);
